...
import { Container, Typography, Grid, Card, CardMedia, CardContent, IconButton, Menu, MenuItem } from '@mui/material';
  ...
  useEffect(() => {
    const fetchVideos = async () => {
      try {
        ...
        const response = await fetch(`${baseUrl}/api/training/all`);
