...
const AccountsTelecallerInvoiceTemplate = () => {
  ...
  // Access the passed state (invoiceData)
  ...
  const handleEdit=() =>{
    navigate('/QuotationForm', { state: { invoiceData } });
  }
  ...
  const fetchPartyById = async () => {
    ...
    try {
      ...
      const response = await fetch(`${baseUrl}/api/telecaller/addParty/getPartyById/${invoiceData.adId}`);
      if (response.ok) {
  ...
  const fetchTableData = async () => {
    try {
      const response = await fetch(`${baseUrl}/api/telecaller/itemSalesTable/getfinalItems/${invoiceData.fId}`); // Replace with your API endpoint
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchAmountsData = async () => {
    try {
      const response = await fetch(`${baseUrl}/api/telecaller/itemsTotal/getTotals/${invoiceData.fId}`); // Replace with your API endpoint
      if (response.ok) {
        const data = await response.json();
  ...
  const handleConvertToInvoice = async () => {
    ...
    try {
      ...
      formData.append("grandTotal", invoiceData.grandTotal); // Add the grandTotal as form data
  
      // Send the quotation data to convert to invoice
      const response = await fetch(
        `${baseUrl}/api/telecaller/invoice/save/${invoiceData.fId}`, // Replace with your endpoint
        {
          method: "POST",
      ...
      >
        ...
        <Box display="flex"  sx={{ marginBottom: '20px' }}>
          <ArrowBackIcon
            ...
            onClick={ () => navigate("/AccountsInvoiceList")}
          />
          <Typography
            variant="body1"
            sx={{
          ...
          >
           Invoice List #{' '}
            <span style={{ color: '#1976d2' }}>{invoiceData.invoiceNumber}</span>
          </Typography>
        </Box>
            ...
            >
             <Typography
              ...
              >
                {/* Header */}
                <CardContent>
                  <Grid container mb={0} alignItems="center" justifyContent="space-between">
                          ...
                          <Grid container direction="column">
                            ...
                            <Grid item>
                              <Typography style={{ fontWeight: "bold" }}>
                                GSTIN:{" "}
                                <span style={{ fontWeight: "normal" }}>{orgData.gstIn}</span>
                              </Typography>
                            </Grid>
                            <Grid item>
                              <Typography style={{ fontWeight: "bold" }}>
                            ...
                            <Grid item>
                              <Typography style={{ fontWeight: "bold" }}>
                                Email:{" "}
                                <span style={{ fontWeight: "normal" }}>{orgData.email}</span>
                              </Typography>
                            </Grid>
                            <Grid item>
                              <Typography style={{ fontWeight: "bold" }}>
                                PAN Number:{" "}
                                <span style={{ fontWeight: "normal" }}>DDWPM2424N</span>
                              </Typography>
                            </Grid>
                          </Grid>
                        </Grid>
                        ...
                        <Grid item>
                          <Box
                            style={{
                              ...
                              fontWeight: "bold",
                              fontSize: "13px",
                              marginRight: "0px", // Align with TAX INVOICE
                              color:"#7D838B"
                            }}
                          >
                      ...
                      >
                        <Grid item>
                          <Grid container justifyContent="space-between">
                            ...
                            >
                              Invoice No<span style={{ marginLeft: "13px" }}>:</span>
                            </Typography>
                            <Typography
                              variant="body1"
                        ...
                        {/* <Grid item>
                          <Grid container justifyContent="space-between">
                            <Typography
                              ...
                              style={{ width: "100px", textAlign: "left" }}
                            >
                              Due Date <span style={{ marginLeft: "20px" }}>:</span>
                            </Typography>
                            <Typography
                              variant="body1"
                              style={{ width: "150px", textAlign: "right" }}
                            >
                              <strong>{invoiceData.quotationNumber}</strong>
                            </Typography>
                          </Grid>
                        </Grid> */}
                      </Grid>
...
export default AccountsTelecallerInvoiceTemplate;