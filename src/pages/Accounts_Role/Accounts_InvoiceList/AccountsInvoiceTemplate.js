...
const AccountsInvoiceTemplate = () => {
  ...
  const fetchPartyById = async () => {
    ...
    try {
      ...
      const response = await fetch(`${baseUrl}/api/addParty/getPartyById/${invoiceData.adId}`);
      if (response.ok) {
  ...
  const fetchTableData = async () => {
    try {
      const response = await fetch(`${baseUrl}/api/itemSalesTable/getfinalItems/${invoiceData.fId}`); // Replace with your API endpoint
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchAmountsData = async () => {
    try {
      const response = await fetch(`${baseUrl}/api/itemsTotal/getTotals/${invoiceData.fId}`); // Replace with your API endpoint
      if (response.ok) {
        const data = await response.json();
  ...
  const handleConvertToInvoice = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${baseUrl}/api/invoice/save/${invoiceData.fId}`, // Replace with your endpoint
        {
          method: "POST",
...
export default AccountsInvoiceTemplate;