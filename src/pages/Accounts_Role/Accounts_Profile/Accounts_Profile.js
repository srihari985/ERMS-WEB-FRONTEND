...
function Accounts_Profile() {
  ...
  const fetchEmployee = async () => {
    try {
      setLoader(true);
      const response = await fetch(`${baseUrl}/api/v1/accounts/getById/${userId}`);
        ...
        employee && (
          <Card sx={{ backgroundColor: 'white', boxShadow: 1, marginTop: 11 }}>
            ...
            <ArrowBackIcon
                ...
                onClick={() => navigate('/AccountsDashboard')}
              />
...
export default Accounts_Profile;
