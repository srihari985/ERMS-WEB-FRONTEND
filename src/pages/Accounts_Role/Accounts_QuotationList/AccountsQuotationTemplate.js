...
const AccountsQuotationTemplate = () => {
  ...
  const apiEndpoints = {
    SaleInvoice: `/api/invoice/convert/sales/${quotationData.saleId}/`,
    DC: "/api/DCInvoice/save/",
    ProformaInvoice: "/api/proFormaInvoice/save/",
  };
...
export default AccountsQuotationTemplate;