...
const AccountsDCTemplate = () => {
  ...
  const fetchPartyById = async () => {
    ...
    try {
      ...
      const response = await fetch(`${baseUrl}/api/addParty/getPartyById/${dcData.adId}`);
      if (response.ok) {
  ...
  const fetchTableData = async () => {
    try {
      const response = await fetch(`${baseUrl}/api/itemSalesTable/getfinalItems/${dcData.fId}`); // Replace with your API endpoint
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchAmountsData = async () => {
    try {
      const response = await fetch(`${baseUrl}/api/itemsTotal/getTotals/${dcData.fId}`); // Replace with your API endpoint
      if (response.ok) {
        const data = await response.json();
  ...
  const handleConvertToInvoice = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${baseUrl}/api/invoice/save/${dcData.fId}`, // Replace with your endpoint
        {
          method: "POST",
...
export default AccountsDCTemplate;