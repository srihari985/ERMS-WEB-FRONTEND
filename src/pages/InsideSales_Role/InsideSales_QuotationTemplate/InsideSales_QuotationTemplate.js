...
const InsideSales_QuotationTemplate = () => {
  ...
  const handleConvertToInvoice = async () => {
    ...
    try {
      ...
      const response = await fetch(
       ` ${baseUrl}/api/invoice/save/telecaller/${quotationData.fId}`, // Replace with your endpoint
        {
          method: "POST",
...
export default InsideSales_QuotationTemplate;