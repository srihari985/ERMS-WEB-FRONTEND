...
const InsideSales_Demo = () => {
  ...
  const handleSubmitWebsiteFeedback = async (values, { setSubmitting, resetForm }) => {
    try {
      const response = await fetch(`${baseUrl}/api/websiteFeedback/save/${sId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleGetClick = () => {
    if (selectedTab === 0) {
      ...
      // Software tab
      if (selectedSoftware === "inventoryFb") {
        setPdfPath("/pdfs/inventoryFb.pdf");
          ...
          <div>
            <Formik
              ...
              onSubmit={async (values, { setSubmitting }) => {
                ...
                const url = `${baseUrl}/api/contactForm/save/${sId}?contactPerson=${values.contactPerson}&contactNumber=${values.contactNumber}&companyName=${values.companyName}&emailId=${values.emailid}&address=${values.address}&gstIn=${values.gstIn}`;
          ...
          {selectedTab === 1 && (
            <div style={{ marginTop: "20px" }}>
              ...
              >
                ...
                >
                  <MenuItem value="inventoryFb">inventoryFb</MenuItem>
