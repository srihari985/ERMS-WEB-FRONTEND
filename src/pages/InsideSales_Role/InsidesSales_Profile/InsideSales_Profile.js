...
function InsideSales_Profile() {
  ...
  const fetchEmployee = async () => {
    try {
      setLoader(true);
      const response = await fetch(`${baseUrl}/api/v1/telecaller/getById/${userId}`);
        ...
        employee && (
          <Card sx={{ backgroundColor: 'white', boxShadow: 1, marginTop: 11 }}>
            ...
            <ArrowBackIcon
                ...
                onClick={() => navigate('/InsideSales_Dashboard')}
              />
...
export default InsideSales_Profile;
