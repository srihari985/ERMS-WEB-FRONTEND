...
export default function InsideSales_TicketsList() {
  ...
  const fetchTickets = async () => {
    try {
      const response = await fetch(`${baseUrl}/api/ticket/ticketHistory/telecaller/${telId}`);
  ...
  const fetchOpenTicketCount = async () => {
    try {
      const response = await fetch(`${baseUrl}/api/ticket/ticketHistory/count/ticketRaise/telecaller/${telId}`);
      const data = await response.json();
   ...
   const fetchCloseTicketCount = async () => {
    try {
      const response = await fetch(`${baseUrl}/api/ticket/ticketHistory/count/ticketClose/telecaller/${telId}`);
      const data = await response.json();
