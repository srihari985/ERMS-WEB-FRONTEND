...
const roles = [ 'OPERATION_TECH_LEAD','SALES', 'TECHNICIAN',"TELECALLER",];
...
const handleSubmit = async (values, { setSubmitting }) => {
    ...
    switch (values.role) {
        case 'OPERATION_TECH_LEAD':
            apiUrl = `${baseUrl}/api/v1/saleManagement/register/operationTechLead/${userId}?firstname=${values.firstname}&lastname=${values.lastname}&email=${values.email}&role=${values.role}&mobileNumber=${values.mobileNumber}`;
            break;  
        case 'SALES':
  ...
  return (
    ...
    >
      ...
      >
        <h2>HR To Sales,Tele,Tech,OperationlManager Registration</h2>
        <Formik
          initialValues={{
            firstname: '',
            lastname: '',
