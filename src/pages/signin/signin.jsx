...
const SignIn = () => {
  ...
  const { setToken, setSId, setloginEmail } = useAuth();
  ...
  //     if (response.ok) {
  //       const result = await response.text(); // Read the plain text response
  ...
  //       setStep(2); // Proceed to password reset form if response is okay
  //     } else {
  //       const errorText = await response.text(); // Read the error response as plain text
  //       console.log("Error Response Text:", errorText); // Log error response for debugging

  //       // Show error toast with custom options
  //       toast.error(errorText || "Failed to send email. Please try again.", {
  //         position: "top-right",
  //         autoClose: 2000,
  ...
  //     // Show error toast for network issues with custom options
  //     toast.error(
  ...
  //   // Handle password reset and navigate back to sign-in on success
...
//SETTING NEW PASSWORD
  ...
  //             console.log("i am organiation id : " + decodedToken.organizationId)
  ...
  return (
    <div
      style={{
        ...
        background:
          'url("https://media.istockphoto.com/id/1009830244/vector/wave-blue-color-texture.jpg?s=170667a&w=0&k=20&c=OaC8LQd4u2fw9sfDifgE4XHQuwpfYQt_PjkDe66vA5k=") no-repeat center center fixed',
        // backgroundColor:'#4f95f0',
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center", marginBottom: "40px", flex: 1 }}>
          ...
          >
▂▃▅▇█▓▒░𝙴𝙼𝙿𝙻𝙾𝚈𝙴𝙴 𝚁𝙾𝙻𝙴 𝙱𝙰𝚂𝙴𝙳 𝙼𝙰𝙽𝙰𝙶𝙴𝙼𝙴𝙽𝚃 𝚂𝚈𝚂𝚃𝙴𝙼░▒▓█▇▅▃▂    </Typography>
        </div>
            ...
            >
              ...
              <div style={{ marginTop: "20px" }}>
                ...
                <Button
                  ...
                  style={{
                    marginTop: "20px",
                    backgroundColor: "rgba(10, 100, 190, 0.1)", // Transparent background
