...
const SignIn = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      switch (role) {
        case 'ORGANIZATION':
          apiUrl = `http://192.168.29.219:8080/api/auth/organize/authenticate?email=${email}&password=${password}&role=${role}`;
          break;    
        case 'ADMIN':
        case 'MANAGER':
        case 'SALE_MANAGER':
        ...
        case 'SALES':
        case 'TELECALLER':
          apiUrl = `http://192.168.29.219:8080/api/v1/auth/authenticate?email=${email}&password=${password}`;
          break;
        default:
