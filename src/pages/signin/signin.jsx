...
const SignIn = () => {
  ...
  const { setToken, setSId, setloginEmail, setfirstName , setrole , setcompanyName , setorgId} = useAuth();
  ...
  return (
    <div
      style={{
        ...
        background:
          'url("https://dm0qx8t0i9gc9.cloudfront.net/thumbnails/video/rN0W64K4ipau8gxv/videoblocks-live-wallpaper-from-slow-moving-shapes-filled-colorful-gradient-and-drop-shadow-4k-abstract-background-animation_bwk4_j6xp_thumbnail-1080_06.png") no-repeat center center fixed',
