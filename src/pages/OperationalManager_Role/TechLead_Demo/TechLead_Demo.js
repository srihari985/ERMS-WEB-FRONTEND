...
const TechLead_Demo = () => {
  ...
  const handleFeedbackSubmit = async (values) => {
    ...
    try {
      ...
      const response = await fetch(
        `${baseUrl}/api/operationTechLead/feedback/save/${oTLId}`,
        {
          method: "POST",
          headers: {
  ...
  const handleSubmitWebsiteFeedback = async (values, { setSubmitting, resetForm }) => {
    try {
      ...
      const response = await fetch(`${baseUrl}/api/operationTechLead/websiteFeedback/save/${oTLId}`, {
        method: 'POST',
          ...
          <div>
            <Formik
              ...
              onSubmit={async (values, { setSubmitting }) => {
                ...
                const url = `${baseUrl}/api/operationTechLead/contactForm/save/${oTLId}?contactPerson=${values.contactPerson}&contactNumber=${values.contactNumber}&companyName=${values.companyName}&emailId=${values.emailid}&address=${values.address}&gstIn=${values.gstIn}`;
