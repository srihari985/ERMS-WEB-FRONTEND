...
function TechLead_Profile() {
  ...
  const fetchEmployee = async () => {
    try {
      setLoader(true);
      const response = await fetch(`${baseUrl}/api/v1/operationTechLead/getById/${userId}`);
        ...
        employee && (
          <Card sx={{ backgroundColor: 'white', boxShadow: 1, marginTop: 11 }}>
            ...
            <ArrowBackIcon
                ...
                onClick={() => navigate('/OperationalManagerDashboard')}
              />
...
export default TechLead_Profile;
