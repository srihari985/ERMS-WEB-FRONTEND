...
const OrganizationForm = () => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    try {
      ...
      const apiUrl = `http://192.168.29.219:8080/api/auth/organize/register/organization?name=${values.name}&email=${values.email}&address=${values.address}&role=${values.role}`;
