...
const Technician_Demo = () => {
  ...
  const handleFeedbackSubmit = async (values) => {
    ...
    try {
      ...
      const response = await fetch(
        `${baseUrl}/api/technician/feedback/save/${tId}`,
        {
          method: "POST",
          headers: {
  ...
  const handleSubmitWebsiteFeedback = async (values, { setSubmitting, resetForm }) => {
    try {
      ...
      const response = await fetch(`${baseUrl}/api/technician/websiteFeedback/save/${tId}`, {
        method: 'POST',
          ...
          <div>
            <Formik
              ...
              onSubmit={async (values, { setSubmitting }) => {
                ...
                const url = `${baseUrl}/api/technician/contactForm/save/${tId}?contactPerson=${values.contactPerson}&contactNumber=${values.contactNumber}&companyName=${values.companyName}&emailId=${values.emailid}&address=${values.address}&gstIn=${values.gstIn}`;
...
export default Technician_Demo;