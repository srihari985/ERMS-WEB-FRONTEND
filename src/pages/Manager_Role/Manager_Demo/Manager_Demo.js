...
const Manager_Demo = () => {
  ...
  const handleFeedbackSubmit = async (values) => {
    ...
    try {
      ...
      const response = await fetch(
        `${baseUrl}/api/manager/feedback/save/${mId}`,
        {
          method: "POST",
          headers: {
  ...
  const handleSubmitWebsiteFeedback = async (values, { setSubmitting, resetForm }) => {
    try {
      ...
      const response = await fetch(`${baseUrl}/api/manager/websiteFeedback/save/${mId}`, {
        method: 'POST',
          ...
          <div>
            <Formik
              ...
              onSubmit={async (values, { setSubmitting }) => {
                ...
                const url = `${baseUrl}/api/manager/contactForm/save/${mId}?contactPerson=${values.contactPerson}&contactNumber=${values.contactNumber}&companyName=${values.companyName}&emailId=${values.emailid}&address=${values.address}&gstIn=${values.gstIn}`;
