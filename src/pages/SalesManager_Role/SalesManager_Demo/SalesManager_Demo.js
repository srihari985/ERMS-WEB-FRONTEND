...
const SalesManager_Demo = () => {
  ...
  const handleFeedbackSubmit = async (values) => {
    ...
    try {
      ...
      const response = await fetch(
        `${baseUrl}/api/saleManager/feedback/save/${smId}`,
        {
          method: "POST",
          headers: {
  ...
  const handleSubmitWebsiteFeedback = async (values, { setSubmitting, resetForm }) => {
    try {
      ...
      const response = await fetch(`${baseUrl}/api/saleManager/websiteFeedback/save/${smId}`, {
        method: 'POST',
          ...
          <div>
            <Formik
              ...
              onSubmit={async (values, { setSubmitting }) => {
                ...
                const url = `${baseUrl}/api/saleManager/contactForm/save/${smId}?contactPerson=${values.contactPerson}&contactNumber=${values.contactNumber}&companyName=${values.companyName}&emailId=${values.emailid}&address=${values.address}&gstIn=${values.gstIn}`;
...
export default SalesManager_Demo;